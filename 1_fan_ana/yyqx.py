# -*- coding: utf-8 -*-
"""
Created on Tue Aug 31 01:06:12 2021
...
for i in range(10):
    n = 0
    path = 'D:\picture\yiyangqianxi_new\\Y' + str(i+1) + '\\'
    print(path)
    files = os.listdir(path)
    for file in files:
        if file[-4:] == '.jpg':
...
with open(savePath + 'yyqx.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
